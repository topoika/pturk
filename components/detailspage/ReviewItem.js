  ...
  return (
    <div className="flex flex-col my-5">
      ...
      <p className="text-sm my-3 text-black font-[400]">
        {
          "fresh-baked pastry traditionally filled with sausage, cheese, or fruit. Like our ancestors, we at Kolache Factory, make our dough daily from scratch, using the finest, freshest ingredients"
        }
      </p>
